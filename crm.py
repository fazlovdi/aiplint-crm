        ...
        if st.session_state.get(f"show_ct_{d['id']}", False):
            with st.container(border=True):
                ...
                if st.button("\u0421\u043e\u0437\u0434\u0430\u0442\u044c", key=f"ct_go_{d['id']}", use_container_width=True, type="primary"):
                    if not ntopic.strip(): st.warning("\u0412\u0432\u0435\u0434\u0438\u0442\u0435 \u0442\u0435\u043c\u0443 \u0437\u0430\u0434\u0430\u0447\u0438")
                    elif not ntm: st.warning("\u0412\u044b\u0431\u0435\u0440\u0438\u0442\u0435 \u043e\u0442\u0432\u0435\u0442\u0441\u0442\u0432\u0435\u043d\u043d\u043e\u0433\u043e")
                    else:
...
def render_deal_in_tree(d, cl):
    ...
    is_dl_tasks_exp = st.session_state.expanded_deal_tasks_id == d["id"]
